    ...
    <div className="grid md:grid-cols-2 items-center overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white my-6 font-[sans-serif]">
      <div className="p-8 bg-gradient bg-gradient-to-bl  from-neutralTwo  to-neutralThree cursor-pointer ">
        ...
        <p className="text-sm text-white mt-4 leading-relaxed">
          Have a specific inquiry or looking to explore new opportunities? We're
        ...
        <form>
          <div className="space-y-4 mt-8">
            <input
              ...
              className="px-2 py-3 bg-transparent text-white w-full text-sm border-b border-gray-400 focus:border-neutralOne outline-none"
            />
            ...
            <textarea
              ...
              className="px-2 pt-3 bg-transparent text-white w-full text-sm border-b border-gray-400 focus:border-neutralOne outline-none"
            ></textarea>
          </div>

          <button
            type="button"
            className="mt-8 flex items-center justify-center text-sm w-full rounded-md px-6 py-3 tracking-wide font-medium text-black bg-neutralOne hover:bg-primaryTwo hover:text-white"
          >
            Send Message
          </button>
        </form>

        <ul className="mt-4 flex flex-wrap justify-start gap-4 lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
